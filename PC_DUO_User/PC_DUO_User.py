...
# UDP 설정
UDP_IP = socket.gethostbyname(socket.gethostname())  # 모든 네트워크 인터페이스에서 수신
...
sock.settimeout(0.0)  # Non-blocking 모드 (딜레이 제거)
...
sock.setblocking(False)  # 또는 settimeout(0.0)
data = None
